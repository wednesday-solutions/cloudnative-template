...
/**
 * Cache for the tenant connection, this will be used for maintaining everything
 * related to a tenant, we can also try and maintain a cache for every tenant.
 */
export class TenantCache extends RedisCache {
  cache: Redis;
